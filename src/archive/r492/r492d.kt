...
//    val (n, r) = readLine()!!.archive.r492.archive.er47.splitToIntArray()
//    val c = readLine()!!.archive.r492.archive.er47.splitToIntArray()
    val n = 18
...
//    repeat(r) {
//        val (z, g) = readLine()!!.archive.r492.archive.er47.splitToIntArray()
//        d[z] = g.toDouble()
//
//    }
}
